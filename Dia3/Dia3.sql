...
select distinct cliente.nombre_cliente, empleado.nombre, empleado.puesto
from pago inner join cliente
on pago.codigo_cliente inner join empleado 
on codigo_empleado_rep_ventas = empleado.codigo_empleado;
...
from pago inner join cliente
on pago.codigo_cliente = cliente.codigo_cliente inner join empleado
on cliente.codigo_empleado_rep_ventas = empleado.codigo_empleado inner join oficina
...
select distinct oficina.linea_direccion1, oficina.lineadireccion2 
from cliente
inner join empleado
on cliente.codigo_empleado_rep_ventas = empleado.codigo_empleado
inner join oficina
...
select distinct cliente.nombre_cliente, empleado.apellido1, oficina.ciudad
from cliente 
inner join empleado
on cliente.codigo_empleado_rep_ventas = empleado.codigo_empleado
inner join oficina
...
from cliente
inner join pedido
on cliente.codigo_cliente = producto.codigo_cliente
where producto.fecha_entrega > producto.fecha_esperada;
